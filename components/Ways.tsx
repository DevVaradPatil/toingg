...
const Ways = () => {
  return (
    <div className="flex flex-col items-center justify-center px-[15vw] w-full ">
      <h1 className="text-[80px] font-extrabold text-[#FFB47E] xs:text-4xl xs:text-center mb-5">
    ...
    {/* Card2 */}
      <div className="flex justify-between items-center gap-10 w-full bg-[#FFF6E8] mt-10 rounded-[30px] py-10 px-10">
